...
const routes: Routes = [{ path: '', component: PaeComponent, children: [
  ...
  {path: 'activitiesDailyLivingPartOne', component: PaeActivitiesDailyLivingPartOneComponent, canActivate: [AuthGuard]},
  ...
  {path: 'activitiesDailyPartOne', component:PaeActivityDailyLivingPartOneComponent, canActivate:[AuthGuard]},
