...
enabledDiagnosisSummary:boolean;
  ...
  ngOnInit() {
    if (localStorage.getItem('selectedMenu')) {
       console.log("inside")
       this.enabledDiagnosisSummary = true;
     }
    this.menuData =[
      { text: "Welcome", id: "welcome", showRequired: true },
      {
        ...
        text: "Diagnosis", id: "diagnosis", children: [
          { text: "Diagnosis Summary", id: "diagnosisSummary" },
          { text: "Medical Diagnosis", id: "medicalDiagnosis", disabled:this.enabledDiagnosisSummary }
        ]
      }, {
        text: "Functional Assessment", id: "functionalAssessmentParent", children: [
          ...
          { text: 'ActivitiesPartOne', id: 'activitiesDailyPartOne' },
        ]
      },
      ...
      { text: "Safety Determination", id: "safetyDetermination", children: [
        { text: "Safety Assessment Summary", id: "safetyAssessmentSummary" },
  ...
  setPageHeader() {
    ...
    if (this.currentUrl !== '/login' && this.currentUser == null) {
      ...
      this.currentUrl = "/dashboard/pae/paeStart";
    } else {
  ...
  getCurrentMenuItem(id: string) {
    ...
    var newUrl = '/dashboard/pae/paeStart' + (id.length > 0 ? "/" + id : "");
